class UpdateDailyNoteStatusesToVersion2 < ActiveRecord::Migration[5.2]
  def change
    # FIX: Bypass broken scenic `replace_view` helper.
    # We manually drop and recreate the view using the provided SQL definition.

    execute "DROP VIEW IF EXISTS daily_note_statuses CASCADE;"
