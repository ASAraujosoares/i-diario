class AdjustFunctionCheckToKeepUniqueConceptualExamsToUseStepNumber < ActiveRecord::Migration[5.2]
  def change
    execute <<-SQL
      DROP FUNCTION check_conceptual_exam_is_unique(INT, INT, INT, DATE);
