# config/initializers/10_fix_pg_add_options_arity.rb

# Fix for ArgumentError: wrong number of arguments (given 2, expected 1) in add_options_for_index_columns
...
module PGAddOptionsArityFix
  def add_options_for_index_columns(quoted_columns, *args, **kwargs)
...
if defined?(ActiveRecord::ConnectionAdapters::PostgreSQLAdapter)
  ActiveRecord::ConnectionAdapters::PostgreSQLAdapter.prepend(PGAddOptionsArityFix)
else
